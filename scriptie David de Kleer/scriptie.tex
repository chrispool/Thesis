...
classifiers worden getraind en geëvalueerd op de testdata.
...
800 woorden met de hoogste tf-idf score selecteren, en we een Naive Bayes classifier gebruiken.
...
combineren met \ttt{wordOverlapUser}, \ttt{wordOverlapSimple} en \ttt{location}, en we een Naive Bayes classifier gebruiken.
\end{bullets}
