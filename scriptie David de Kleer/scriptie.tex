...
\ttt{incident} of \ttt{anders}, waarvoor we twee
...
behalen we een accuracy van 84\%: slechts 2\% lager dan de \it{upper bound} (onze eigen prestaties op een
event detection taak) van 86\%. De gedetecteerde events worden gevisualiseerd met behulp
